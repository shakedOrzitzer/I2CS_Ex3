...
The Ex3Algo class automates Pac-Man gameplay using a State Machine and BFS pathfinding. This combination allows the pacman to navigate the maze efficiently, maximizing scores while intelligently outmaneuvering ghosts.

---

## 🧠 Algorithmic Logic: The State Machine
